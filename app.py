...
lineaccesstoken = '9MHsw6HFpDhJ5XsXBEWrP11LOeIApytE8dGy+/4P4ajk70zPSd6Wtx0mSpZAtZV88dQ/X8RPwFZkuXvDeGNSVlAMGis3S6XS87ZqXTFZUKBAeVVXSPEv9yk/3eO2ZNohgSl781MNsf/02YtSNTp7mwdB04t89/1O/w1cDnyilFU='
...
def event_handle(event,json_line):
    ...
    if msgType == "text":
        ...
        if (msg == "เอง") :
            ...
            line_bot_api.reply_message(rtoken, replyObj)
        elif (msg == "ไปดูเน็ตฟิกกัน") :
            replyObj = TextSendMessage(text="ป่ะล่ะ")
            line_bot_api.reply_message(rtoken, replyObj)
        elif (msg == "ไปกินข้าวกัน") :
            replyObj = TextSendMessage(text="เคไปๆ")
            line_bot_api.reply_message(rtoken, replyObj)
        else : 
            headers = request.headers
            json_headers = ({k:v for k, v in headers.items()})
            json_headers.update({'Host':'bots.dialogflow.com'})
            url = "https://dialogflow.cloud.google.com/v1/integrations/line/webhook/ed365856-f334-4de0-b80f-9684807c6e3f"
